---
id: 5ce93ee8d000c62713952f7db649a69b0c87d271fba6eb8fd2cb8185df47f13f
title: 'Full - Stack - Entwickler:in - Python / Django / React'
company: DataCollect Traffic System GmbH
location: Kerpen
applicationLink: >-
  https://www.arbeitnow.com/jobs/companies/datacollect-traffic-system-gmbh/full-stack-entwicklerin-python-django-react-kerpen-156030
postedDate: '2025-11-28T13:32:13.000Z'
expirationDate: null
tags:
...
companyLogoUrl: null
companyCulture: >-
  The company fosters a collaborative, technology-forward, and innovative
  culture, emphasizing continuous improvement through AI and automation, while
  offering flexibility, remote options, and significant growth opportunities in
  challenging, real-world projects.
story_question1: >-
  Considering the blend of embedded systems, cloud platforms, and the active
  modernization of existing applications, what do you see as the biggest
  technical challenge for a Full-Stack Developer in ensuring seamless
  integration and scalability across the entire ecosystem?
story_answer1: >-
  That's a fantastic question, and it really hits at the heart of what we do.
  The biggest challenge, and also the most rewarding, is truly orchestrating the
  interaction between our embedded devices, the web applications running on
  them, and our robust cloud platforms. We're not just building features; we're
  crafting an integrated experience from sensor to screen. What makes it
  exciting is our culture of collaboration – our Embedded, Web, and System
  Architecture teams work hand-in-hand. This role isn't just about writing code;
  it's about being an architect of connectivity, solving complex integration
  puzzles daily, and seeing your solutions directly impact how traffic systems
  are managed and visualized. The drive to modernize means you're constantly
  pushing boundaries, contributing to a tangible, real-world product that makes
  a difference.
story_question2: >-
  The job description highlights a strong emphasis on leveraging AI-supported
  development tools. How does the company actively support and encourage
  developers to integrate these new technologies into their daily workflows and
  what kind of impact are you seeing from this approach?
story_answer2: >-
  We're really passionate about staying at the forefront of technology, and that
  absolutely includes AI. We don't just talk about AI tools; we actively
  integrate them. We encourage developers to experiment with tools like Claude
  Code and ChatGPT for improving code quality, accelerating documentation, and
  streamlining development processes. We even provide dedicated resources and
  training, fostering a 'learn-by-doing' environment. The impact has been
  significant: developers are reporting increased efficiency, fewer repetitive
  tasks, and more time to focus on complex, creative problem-solving. It's truly
