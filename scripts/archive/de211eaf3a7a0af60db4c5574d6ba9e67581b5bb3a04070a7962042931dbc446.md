---
id: de211eaf3a7a0af60db4c5574d6ba9e67581b5bb3a04070a7962042931dbc446
title: Server-OS Automation and Gen AI Engineer
company: Barclays
location: 'Pune, Maharashtra, India'
applicationLink: >-
  https://barclays.wd3.myworkdayjobs.com/external_career_site_barclays/job/Gera-Commerzone-SEZ--Pune/Server-OS-Automation-and-Gen-AI-Engineer_JR-0000058244
...
source: hiring.cafe
sourceUrl: >-
  https://hiring.cafe/jobs/workday___barclays-wd3-external_career_site_barclays___server-os-automation-and-gen-ai-engineer_jr-0000058244
companyLogoUrl: null
---
**Job Description**
===================
...
Join us as a Server-OS Automation and Gen AI Engineer at Barclays, responsible for supporting the successful delivery of Location Strategy projects to plan, budget, agreed quality and governance standards. You'll spearhead the evolution of our digital landscape, driving innovation and excellence. You will harness cutting-edge technology to revolutionise our digital offerings, ensuring unparalleled customer experiences.

To be successful as a Server-OS Automation and Gen AI Engineer you should have experience with:

*   Good Years of relevant experience.
*   Must be an engineering graduate.
*   Knowledge of Server platform, Linux and Unix operating system.
*   Proven infrastructure automation skills.
*   Prompt Engineering.
*   Crafting effective prompts for LLMs and multimodal models.
*   Fine-Tuning & Transfer Learning: Adapting pre-trained models to domain-specific tasks.
*   Retrieval-Augmented Generation (RAG): Integrating external knowledge sources for enhanced responses.
*   API Integration: Connecting GenAI models to enterprise systems and user interfaces.
*   Tooling & Platforms.
*   Cloud & DevOps: Azure, AWS Bedrock, GCP, Docker, Kubernetes.
*   Observability & MLOps: MLflow, Databricks, GitLab CI/CD, dashboards.
