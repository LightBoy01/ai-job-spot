...
applicationLink: >-
  https://jobs.capgemini.com/job/S%C3%A3o-Paulo-Cientista-de-Dados-Python-SP/1253029901/
...
Estamos em busca de um(a) **Cientista de Dados Python**, para compor nosso time. 

**Responsabilidade do Cargo:**

Garantir a performance e a assertividade dos canais de IA generativa.  
Gerar dados para análise e monitoramento contínuo.  
Realizar análises detalhadas de casos com baixa assertividade da IA.  
Categorizar causas dos problemas para direcionamento das correções.  
Monitorar o desempenho da IA após ajustes, garantindo evolução contínua.  
Elaborar relatórios semanais e mensais com indicadores de performance.  
Apresentar resultados em reuniões periódicas com stakeholders.

**Requisitos Técnicos:** 

Experiência em análise de dados e interpretação de resultados.  
Programação em Python para geração e manipulação de bases de dados.  
Conhecimento em Inteligência Artificial e Machine Learning.  
Experiência com chatbots e interfaces conversacionais.  
Interesse por tecnologias disruptivas e tendências em IA.
