...
async function generateUniqueSlug(title: string, dir: string, isJob: boolean): Promise<string> {
...
async function main() {
  try {
    ...
    if (type.toLowerCase() === 'a') {
      ...
      console.error('Invalid type. Please enter "j" for job or "a" for article.');
    }
  } catch (error) {
