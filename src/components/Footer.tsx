        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              <a href="https://twitter.com/aijobspot" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-secondary transition-colors">
              ...
              <a href="https://linkedin.com/company/aijobspot" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-secondary transition-colors">
