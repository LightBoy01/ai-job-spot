...
applicationLink: "https://button.bamboohr.com/careers/30"
...
source: "https://button.bamboohr.com/careers/30"
story_question1: "What is the most exciting challenge for this role in the first 90 days?"
story_answer1: "In your first 90 days, you won't be siloed in a single department. You'll be Button's 'AI Ambassador,' working across marketing, finance, legal, and engineering to identify and build real-world AI solutions. The most exciting challenge will be to move beyond theory and apply your skills to create tangible business value, whether that's through a contract analysis tool for the legal team or a financial modeling assistant. You'll be learning and building in real-time."
story_question2: "What is a quality you're looking for that isn't on the formal job description?"
story_answer2: "We're looking for a 'creative problem-solver.' This isn't just about coding; it's about seeing a manual process or a business challenge and imagining how AI can make it better. We want someone who is curious, proactive, and not afraid to propose and prototype new ideas, even if they're outside the initial scope of a project."
story_question3: "How does this role contribute to the company's larger mission?"
story_answer3: "Button's mission is to build a better internet fueled by commerce. As our AI Intern, you'll be helping us build a better Button. By creating efficiencies and unlocking new capabilities across the company, you'll be directly contributing to our ability to innovate and deliver on our mission. You'll be helping us work smarter, not just harder."
---
...
- Evaluate the performance of AI tools, measure impact, and recommend improvements.
...
- You enjoy exploring how technology can remove friction, automate tasks, and unlock new insights.
- You’re self-motivated, able to manage multiple priorities, and excited to take ownership of projects.
- You communicate clearly and enjoy collaborating with teammates who may not have a technical background.
- You are familiar with AI platforms such as ChatGPT, Gemini, Claude, or similar. You’ve built or contributed to an AI-driven tool, chatbot, or automation project.
- You’re interested in startups, ecommerce, and/or mobile technology.
