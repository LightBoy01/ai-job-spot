---
id: hiringcafe-grnhse___unity3d___7260795
title: 'Senior Backend Engineer, AI Infrastructure'
company: Unity Technologies
location: 'San Francisco, California, United States'
applicationLink: 'https://unity.com/careers/positions/7260795?gh_jid=7260795'
postedDate: '2025-09-26T21:01:43.000Z'
expirationDate: null
tags:
...
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___unity3d___7260795'
companyLogoUrl: null
---
**The opportunity**  
...
We are looking for a versatile, self-driven Senior Backend Engineer who can work across different levels of abstraction and contribute as an active technical leader. In this role, you will design, build, and maintain backend systems that support advanced ML-powered tools, including asset generation and LLM inference, to enable AI-assisted game creation.

**What you'll be doing**

*   Design, build, and maintain backend services and APIs that support AI-powered game authoring tools
*   Develop scalable, high-availability systems used across Unity’s ML and AI ecosystem
*   Collaborate with engineers, data scientists, and product managers to deliver new features and ML-driven experiences
*   Improve performance, reliability, observability, and cost-efficiency of backend systems
...
*   Familiarity with cloud infrastructure and observability tools (e.g. Kubernetes, Grafana, etc.)
*   Understanding of API design, distributed systems, and system reliability
*   Strong understanding of software development best practices, a quality-first mentality and approach
...
*   Familiarity with languages like Python, Golang
