---
id: hiringcafe-oraclecloud___fa-espx-saasfaprod1.fa.ocs___2419278
title: AI Developer
company: Cummins Inc.
location: 'Pune, Maharashtra, India'
applicationLink: >-
  https://fa-espx-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/requisitions/job/2419278
postedDate: '2025-09-30T16:26:22.854Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/oraclecloud___fa-espx-saasfaprod1.fa.ocs___2419278'
companyLogoUrl: null
---
...
*   AI Solution Development: Design, build, and deploy AI models including machine learning, natural language processing (NLP), and computer vision tailored to commercial use cases.
*   Cloud Integration: Utilize services such as Amazon SageMaker, AWS Comprehend, Azure Machine Learning, and Azure Cognitive Services to deliver scalable, cloud-native solutions.
*   Data Engineering: Manage large datasets, perform data cleansing, transformation, and feature engineering to support model training and evaluation.
*   Business Application: Implement AI capabilities for use cases like lead scoring, churn prediction, intelligent virtual assistants, and automated support workflows.
*   Cross-Functional Collaboration: Work closely with stakeholders across sales, service, product, and data science teams to align technical solutions with business goals.
*   Innovation & Optimization: Stay current with emerging AI/ML trends and cloud technologies to continuously improve solution performance and relevance.

Required Qualifications

*   Bachelor’s or Master’s degree in Computer Science, Data Science, or a related field.
*   Proven experience as an AI Developer, Machine Learning Engineer, or similar role.
*   Strong proficiency in Python and familiarity with ML frameworks such as TensorFlow, PyTorch, or Scikit-learn.
*   Hands-on experience with AWS (e.g., SageMaker, Lambda, EC2) and Azure (e.g., Azure ML, Functions, VMs).
*   Demonstrated success in applying AI to commercial environments, particularly in sales and service domains.
*   Excellent analytical thinking and the ability to translate business requirements into scalable technical solutions.
