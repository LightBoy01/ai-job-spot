---
id: hiringcafe-grnhse___scopely___4924418008
title: ' Intern - Technical Art '
company: Scopely
location: 'Bangalore, Karnataka, India'
applicationLink: 'https://job-boards.greenhouse.io/scopely/jobs/4924418008'
postedDate: '2025-09-24T09:10:36.000Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___scopely___4924418008'
companyLogoUrl: null
---
Scopely is looking for a **Technical Art - Intern** to join the **Looney Tunes - World of Mayhem** team in Bangalore on a hybrid basis!

At Scopely, we care deeply about what we do and want to inspire play, every day - whether in our work environments alongside our talented colleagues, or through our deep connections with our communities of players. We are a global team of game lovers who are developing, publishing and innovating the mobile games industry, connecting millions of people around the world daily.  

The Looney Tunes: World of Mayhem team embraces the "One Team, One Dream" culture every day. Everybody is empowered to work with a high level of autonomy and ownership to deliver the best possible player experience..  
  

**What You’ll Do**   

*   Assist and review 3D artists and animators in integrating 3D assets in Unity
*   Create or tweak animations and vfx that run efficiently on mobile platforms
*   Leverage Gen AI to develop tools , editor scripts to improve workflows.
*   Profile builds on target devices, collect FPS/memory data and flag performance spikes to your mentor.
*   Help document tools, pipelines and best‑practice check‑lists.
*   Proactively surface technical art constraints early in production and suggest work‑arounds.
*   Assist other technical artists and product team in live-ops assets integration and management.
*   Join daily stand up meetings, and take ownership of  tasks assigned.

**What We’re Looking For** 

*   Strong knowledge of Unity
*   Ability to create good quality vfx and animations optimized for mobile platforms.
*   Basic knowledge of Git 
*   Portfolio that shows at least one Unity project featuring custom animation, VFX, Shaders, and Basic tooling.
*   Foundational grasp of animation principles, particle systems and shaders.
*   Basic knowledge of profiling and mobile game optimisation and performance.
*   Basic knowledge of Maya, 3ds Max, Blender or other DCC tools.
*   Bonus points for exposure to Python, HLSL, Version Control tools and Generative‑AI workflow
