---
id: hiringcafe-grnhse___airbyte___5588960004
title: 'Senior Software Engineer, Fullstack '
company: Airbyte
location: 'San Francisco, California, United States'
applicationLink: 'https://job-boards.greenhouse.io/airbyte/jobs/5588960004'
postedDate: '2025-09-29T09:31:44.346Z'
expirationDate: null
tags:
...
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___airbyte___5588960004'
companyLogoUrl: null
---
...
You'll be joining a senior team of frontend engineers who own the Airbyte frontend end to end. We have big plans for expanding our data product to include orchestration, data observability, lineage, and streaming. You will design and build  products that will allow Airbyte to be the single pane of glass for data teams and individuals to manage their entire data operation in one tool. These features will be game-changing for our open source community and will be a massive expansion driver for our Enterprise business.

The Airbyte UI is intuitive and powerfully simplifies complex data replication for everyone. It empowers non-technical users to get up and running quickly and equips power users to optimize and monitor their pipelines. In addition to feature development, you will help set the conventions and best practices for the entire frontend codebase.

**What You'll Do**

*   Build new products 

*   Including orchestration, data observability, lineage, and streaming

*   Own the Airbyte frontend
*   Work with a talented team to build a great internal development experience for developers and a great user experience for our users
*   Define and promote conventions and best practices for the frontend
*   Write high-leverage code
*   Mentor other engineers

**What You'll Need**

*   An insatiable desire to ship, relentlessly improving user experience
*   Expert knowledge of frontend technologies. Our frontend stack is Typescript and React
*   Willingness to understand, read, and tweak API code to unblock frontend projects
*   6+ years of software engineering experience
*   Experience working directly with, onboarding, and supporting the users of your products
*   A passion for continuous learning and improvement (both at a personal and team level)
*   You have already incorporated AI tools into the way you work

**Nice to Have**

*   Knowledge and some experience with other programming languages. We’re using Java and Kotlin in the platform backend
