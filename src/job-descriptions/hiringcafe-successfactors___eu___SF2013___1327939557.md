---
id: hiringcafe-successfactors___eu___SF2013___1327939557
title: 'Change Agent (Barcelona, ES)'
company: Zurich
location: 'Barcelona, Catalonia, Spain'
applicationLink: 'https://www.careers.zurich.com/job/Barcelona-Change-Agent/1327939557/'
postedDate: '2025-09-26T20:37:26.268Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/successfactors___eu___SF2013___1327939557'
companyLogoUrl: null
---
¡Hola!
...
**Y te preguntarás: Paula, ¿cómo será mi día a día con la camiseta azul? Me encanta que me hagas esta pregunta (yo también me la hice en su momento):** 

Liderarás la ejecución de proyectos estratégicos de la crew asegurando la entrega de valor y acompañando al área en el cumplimento de sus objetivos:

*   Liderarás integralmente los proyectos: identificar áreas de trabajo implicadas, planificar estratégicamente, y traducir necesidades globales en entregables concretos.
*   Gestionarás los proyectos estratégicos y harás seguimiento de los KPIs estratégicos.
*   Darás soporte en la gestión del cambio y recogida de beneficios, cuantificando los beneficios esperados.
...
*   Influirás en los stakeholders para alinear prioridades. Establecerás comunicaciones eficaces y fluidas a todos los niveles de la organización.
*   Detectarás anticipadamente riesgos y mitigarlos con resolución e innovación.

Definirás con el área iniciativas nuevas de transformación que permitan conseguir los objetivos del ciclo estratégico:

*   Identificarás nuevos proyectos para incluir en el roadmap, planificando según prioridades, recursos y presupuesto.
*   Perseguirás objetivos y proyectos alineados con la estrategia de la organización.
*   Priorizarás oportunidades con visión cliente y en función de los impactos/beneficios de negocio.

Impulsarás planes de mejora continua para la simplificación de procesos.

Fomentar e impulsar la agenda de IA, identificando oportunidades dentro del segmento
...
*   Experiencia previa de al menos 4-5 años en funciones similares (Business Analyst, Project Manager o Consultoría Estratégica de Negocio).
*   Experiencia en consultoría y gestión de proyectos estratégicos.
*   Conocimientos avanzados de ofimática, LEAN, SIX Sigma.
*   Experiencia en proyectos/aplicación de Robotics e Inteligencia Artificial.
*   Experiencia acreditada en Project Management (Agile, Scrum, Waterfall).
*   Nivel de inglés C1 deseable.
*   Habilidades en la gestión de stakeholders, orientación a resultados, foco en cliente, capacidad de influencia y liderazgo.
