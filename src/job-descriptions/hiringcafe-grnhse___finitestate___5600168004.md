---
id: hiringcafe-grnhse___finitestate___5600168004
title: Staff Product Designer
company: Finite State
location: United States or Canada
applicationLink: 'https://job-boards.greenhouse.io/finitestate/jobs/5600168004'
postedDate: '2025-09-29T09:31:50.364Z'
expirationDate: null
tags:
  - Design
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___finitestate___5600168004'
companyLogoUrl: null
---
...
We’re seeking a Staff Product Designer to own and elevate the end‑to‑end user experience across our web application, developer tools, and emerging AI‑agent interfaces. You’ll be the individual contributor design expert, partnering closely with product managers and engineers to craft intuitive and highly usable experiences for our customers and their AI agents. Your focus will span:

*   **Information Architecture:** Ensure that users can easily find what they need and understand how to use our product and access information within it
*   **Data-Driven User Journey Optimization:** Use analytics and user research to improve and refine customer experience
*   **Design Standards and Tooling:** Enable our development team to accelerate their AI-driven delivery of new features and capabilities while maintaining a scalable, responsive, accessible web experience

### **Responsibilities**

*   Lead user research efforts (interviews, contextual inquiry, usability testing) to uncover pain points and validate design hypotheses.
*   Translate research insights into lightweight design documentation
*   Collaborate with engineers to ensure designs are implemented accurately and performantly.
*   Enhance and maintain our design system, UI component library, and style guidelines.
*   Advocate for accessibility and inclusive design best practices throughout the product lifecycle.
*   Be a subject matter expert on designing for AI and emerging interaction paradigms

### **Qualifications**

*   8+ years of hands‑on UX design experience for complex web applications or developer platforms
*   Strong domain understanding of product security and software supply chain security including binary scanning, software bill of materials (SBOM), security analysis and remediation 
*   Proven track record designing AI‑enhanced experiences or agentic interfaces
*   Expert proficiency with rapid prototyping tools and familiarity with AI‑augmented design workflows
*   Strong foundation in user research methodologies and translating findings into actionable design solutions
*   Deep understanding of interaction design principles, information architecture, and visual hierarchy
*   Excellent communication skills and ability to present design rationale to technical and non‑technical stakeholders
*   Based in the U.S. or Canada and authorized to work without sponsorship
