---
id: hiringcafe-taleo_careersection_ircareers_2506006
title: >-
  Spécialiste du support CVC, d'IA / AI, HVAC Support Specialist in Laval QC 
  1950 rue John Molson, Laval, Quebec, Canada
company: Trane Technologies
location: 'Laval, Quebec, Canada'
applicationLink: >-
  https://ttcareers.referrals.selectminds.com/jobs/sp%C3%A9cialiste-du-support-cvc-dia-ai-hvac-support-specialist-81565
postedDate: '2025-09-26T20:43:28.486Z'
expirationDate: null
tags:
  - Engineering
...
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/taleo_careersection_ircareers_2506006'
companyLogoUrl: null
---
🌎
...
Spécialiste du support CVC, d'IA / AI, HVAC Support Specialist
==============================================================

#### 🔍 Laval QC 1950 rue John Molson, Laval, Quebec, Canada
...
*   Expérience avec les plateformes et services cloud (par exemple, AWS, Azure, Google Cloud).
*   Expérience avec les logiciels, la programmation et le matériel BMS (Distech, Schneider Electric, Delta Controls, autres, etc.).
*   Connaissance approfondie des systèmes d'automatisation des bâtiments, des systèmes CVC et mécaniques, de l'électricité, de la réfrigération et de l'exploitation des bâtiments
*   Expérience dans la mise en service de commandes et de systèmes d'automatisation CVC des bâtiments
*   Expérience des protocoles de systèmes de gestion des bâtiments tels que BACnet, Modbus, Lonworks, DIII-net
*   Solide expérience des systèmes d'exploitation Unix/Linux
*   Expérience dans la navigation, la programmation, l'exécution de commandes et de scripts dans divers environnements Linux
*   Solides connaissances en informatique et en réseaux, configuration et architecture
*   Solides compétences en matière d'organisation et de communication, collaboration avec plusieurs services
*   Capacité à mener plusieurs tâches de front et à travailler de manière autonome
...
**Rémunération :**  
Plage salariale de base : $85,000 - $113,000.

Avis : Cette plage salariale de base est basée sur des moyennes nationales canadiennes. La rémunération effective peut varier selon l’ancienneté, le mérite et la localisation géographique du lieu de travail.
...
Join our fast-growing Artificial Intelligence company as an **AI, HVAC Support Specialist**. Your mission: ensure smooth operations without ever leaving your desk. You'll be the first to spot and address issues, coordinate solutions, and keep a vigilant eye on our buildings. This is a desk-based role, no fieldwork required. 

Your overarching objective being to monitor troubleshoot our deployed models on customer sites in real-time.
...
*   Collaborate with development and algorithm teams to integrate with control systems IoT devices and other deployment models.
...
*   Review and help establish Service Level Agreements (SLAs), ensuring adherence and contributing to the quality control in algorithm development
*   Contribute to maintenance and system update activities on client’s systems.
*   Support Knowledge base (KCS) process improvements and troubleshooting efficiency by applying the _shift-left_
*   Communicate directly with clients to address issues and service requests. 
*   Be available for after-hours coverage, including nights, weekend, or holidays, when business needs require it, with appropriate compensation provided.
...
*   Experience with building management system protocols like, BACnet, Modbus, Lonworks, DIII-net
...
Associé(e) en Ingénierie CVC / HVAC Engineering Associate
...
Digital Services Technician / Techniciens de Services Digitaux
