---
id: hiringcafe-grnhse___eucalyptus___4600519005
title: Clinical Knowledge Lead
company: Eucalyptus
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___eucalyptus___4600519005'
companyLogoUrl: null
---
...
Our 5 clinics ([Juniper](http://www.myjuniper.com), [Pilot,](https://pilot.com.au/) [Kin](http://www.kinfertility.com.au), [Software](http://skin.software), & [Compound](https://www.compound.co/)) focus heavily on personalising the experience for different demographics and are powered by a growing team across 5 countries (Australia, UK, Germany, Japan, and the Philippines).
...
Since reaching over 60,000 patients globally through our weight management program, our goal over 2025 is to extend access to our core treatment program to over 100,000 patients, whilst launching into new conditions, demographics, and geographies as we move towards our vision of creating a preventive healthcare ecosystem.
...
As our Clinical Knowledge Lead, you will be the medical authority ensuring that every insight we deliver is clinically sound, safe, and genuinely transformative. This is your chance to shape the clinical backbone of a platform that will reach hundreds of thousands of patients around the world, lifting engagement and improving outcomes.

Working closely with data scientists, product leaders, and fellow clinicians, you will design and oversee rigorous validation processes, interpret complex medical data, and provide clear, actionable feedback to continuously improve our health insights.

**This is a part-time contract role to begin with, with opportunities to move to a more permanent position in the future.**

*   **Validate the clinical accuracy** of AI-generated health insights across diverse scenarios
*   **Ensure clinical accuracy, reliability, and clarity**, aligned with accepted medical standards
*   **Design and develop evaluation frameworks**, including clinical performance metrics, test-cases, and ongoing validation strategies
*   **Collaborate** with data scientists, ML engineers, product managers, and regulatory teams to integrate medical rigor into AI outputs
*   **Develop clinical guidelines, usage protocols, and training materials** for stakeholders interpreting AI

### **About you (Who Are We Looking For)**

*   **Senior Clinical Experience** - ideally a specialist GP background (FRACGP, FACRRM or equivalent) as you will have significant clinical autonomy and manage and lead other clinicians across multiple disciplines and specialty areas
*   **Clinically Innovative** - you are constantly at the forefront of emerging evidence, changing clinical practice and improving patient experience
*   **Ambiguity & a fast-paced environment excites you** – Your curiosity drives you to ask ‘why?’ to get to the next level of understanding; and you can do this work at speed.
*   **Exceptional communicator** – You distill complex medical knowledge or reasoning into clear non-clinical language. You are able to cut through the noise to get to what will matter the most to patients. You are able to articulate what makes great bedside manner and replicate that in our experience.
*   **Interest in digital health, AI, or health technology** - Bonus if you have prior experience, but not required
