---
id: >-
  hiringcafe-workday___centific-wd1-centific_ecs_sea___ai-data-associate_jr104874
title: AI Data Associate
company: Centific
location: Penang or Johor
applicationLink: >-
  https://centific.wd1.myworkdayjobs.com/centific_ecs_sea/job/Malaysia-Office--Penang/AI-Data-Associate_JR104874
postedDate: '2025-09-30T16:26:24.316Z'
expirationDate: null
tags:
  - Data and Analytics
  - Annotating content
...
source: hiring.cafe
sourceUrl: >-
  https://hiring.cafe/jobs/workday___centific-wd1-centific_ecs_sea___ai-data-associate_jr104874
companyLogoUrl: null
---
**About Centific**
...
*   Annotate content based on given standards and guidelines.
*   Grade assignments, projects, or assessments.
*   Provide relevant data and prompt responses based on content.
*   Provide feedback when discrepancies arise.
*   Conduct research on various topics using reliable internet sources. 
*   Conduct data collections based on client requirements. 
*   Maintain detailed records for tracking and reporting.
*   Collaborate to refine grading rubrics and annotation criteria. 
*   Provide timely and accurate evaluation. 
*   Gather information or data from various sources. 
