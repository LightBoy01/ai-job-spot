---
id: hiringcafe-oraclecloud___fa-etvl-saasfaprod1.fa.ocs___135491
title: ESaaS - SFDC -  Marketing Development
company: Zensar Technologies Ltd
location: India
applicationLink: >-
  https://fa-etvl-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/requisitions/job/135491
postedDate: '2025-09-23T09:10:25.000Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/oraclecloud___fa-etvl-saasfaprod1.fa.ocs___135491'
companyLogoUrl: null
---
**Job Description: Salesforce Marketing Cloud Architect**

**Location:** Remote / Offshore  
**Role Type:** Full-time / Contract

**About the Role:**  
We are seeking a highly skilled and strategic Salesforce Marketing Cloud Architect to lead the transformation of our marketing technology stack. This role is central to unifying our data silos, activating AI-driven personalization, and establishing a robust governance framework to drive scalable growth. The ideal candidate will have deep expertise in the Salesforce Marketing Cloud ecosystem, particularly Marketing Cloud Account Engagement (MCAE), Data Cloud, and Personalization (Interaction Studio), and a proven ability to architect solutions that deliver tangible business outcomes.
...
*   8+ years of experience in marketing technology, with at least 5+ years specifically as a Salesforce Marketing Cloud Architect or in a similar solution architecture role.
...
*   Experience with **web technologies**: data layers (CIM, SDR), server-side tag management (sGTM), and consent management platforms (e.g., OneTrust).
*   Excellent analytical skills with the ability to design outcome-driven reporting frameworks (e.g., See-Think-Do-Care).
*   Strong communication and stakeholder management skills, with the ability to articulate complex technical concepts to non-technical audiences.

**Preferred Qualifications:**

*   Salesforce Marketing Cloud Architect Certification or similar advanced certifications.
*   Experience with B2B marketing and ABM strategies.
*   Familiarity with Microsoft Fabric, Azure Synapse, or other enterprise data warehouse platforms.
*   Experience in a global organization with complex business unit structures.
