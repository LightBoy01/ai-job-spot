---
id: hiringcafe-grnhse___thetradedesk___4840436007
...
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___thetradedesk___4840436007'
companyLogoUrl: null
---
...
You’ll be joining a dedicated team focused on building internal-facing AI solutions that support teams across The Trade Desk. We leverage technologies like large language models, retrieval-augmented generation (RAG), and agentic tools to enhance productivity, streamline workflows, and eliminate friction in everyday processes. Our work emphasizes high-quality, scalable applications that deliver measurable value and improve day-to-day operations across the company.

As an AI Software Engineer on this team, you’ll be an end-to-end owner—collaborating closely with stakeholders, identifying opportunities, and delivering tools that make a real impact. We’re a nimble, fast-paced, and highly collaborative group that thrives on transforming the way teams operate and driving greater value across The Trade Desk.
...
*   You have 7+ years of software engineering experience, including 2+ years working on AI-powered systems or products.
*   You are proficient in Python and comfortable with additional languages such as C#, SQL, or TypeScript/React.
*   You have hands-on experience with LLM orchestration frameworks (e.g., LangChain, LlamaIndex, Semantic Kernel) and prompt engineering using LLM APIs.
