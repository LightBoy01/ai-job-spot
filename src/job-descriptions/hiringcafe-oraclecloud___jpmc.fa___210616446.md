---
id: hiringcafe-oraclecloud___jpmc.fa___210616446
title: >-
  J.P. Morgan Wealth Management - Vice President - Product Accelerator GenAI
  Product Manager
company: 189174-INVESTMENT TECHNOLOGY-NY/DE
location: 'Plano, Texas, United States'
applicationLink: >-
  https://jpmc.fa.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/requisitions/job/210616446
postedDate: '2025-09-27T04:05:00.000Z'
expirationDate: null
tags:
  - Product Management
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/oraclecloud___jpmc.fa___210616446'
companyLogoUrl: null
---
Digital Product Strategy & Acceleration is part of the Product Acceleration Garage (PAG) in Wealth Management Product & Experience. This team takes new and innovative ideas and turns them into real, tangible technologies from concept all the way to launch. We develop the strategic vision, prioritize our roadmap, and quickly build and test our proof-of-concepts. Our team works across US Wealth Management to develop the next generation of advanced technology and bring them to market.

As a Senior Product Associate on the Wealth Management Product Accelerator GenAI team, you will play a pivotal role in all aspects of a product cycle, from evaluating the business value and time to market, to defining product requirements, and to being a driving force behind rapid iteration and experiment. The role is perfect for individuals who are not only excited about the latest technology and trends, but also possess strong capabilities of problem solving, strategic thinking, multi-tasking, communication, and collaboration with various businesses and functional areas across J.P. Morgan Wealth Management. 
...
*   Highly self-motivated with the ability to take initiative, problem solve, and excel in ambiguity
*   Ability to ask intelligent questions that push the team further regardless of title

**Preferred qualifications, skills, and capabilities**

*   M.B.A. or graduate degree in relevant field desired
*   Previous experience in management consulting or digital product desired
