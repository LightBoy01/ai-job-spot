---
id: hiringcafe-successfactors___com___HALprod___1315426000
title: >-
  AI-Enabled Python Developer with Full Stack Exposure (Bengaluru, KA, IN,
  560103)
company: Halliburton
location: 'Bengaluru, Karnataka, India'
applicationLink: >-
  https://jobs.halliburton.com/job/Bengaluru-AI-Enabled-Python-Developer-with-Full-Stack-Exposure-KA-560103/1315426000/
postedDate: '2025-09-30T02:49:03.358Z'
expirationDate: null
tags:
...
hasSalary: false
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/successfactors___com___HALprod___1315426000'
companyLogoUrl: null
---
...
*   Collaborate with Product Managers and QA teams to implement new product functionality.
...
**Qualifications:**
*   Bachelor’s or Master’s degree in Computer Science, Engineering, or a related discipline is required.
*   Mandatory Primary Skill: Minimum 2+ years of hands-on experience with Python, including exposure to
frameworks/tools such as LangChain, LangGraph, and foundational AI concepts.
*   Preferred Secondary Skills: Experience with Angular, Node.js, HTML5, CSS/SASS, and responsive UI
development.
*   Good understanding of relational databases (e.g., SQL Server, PostgreSQL), containerization using
Docker, orchestration with Kubernetes, microservices architecture, API integration, and system design is
required.
*   Familiarity with version control systems (e.g., Git), CI/CD pipelines, and Agile methodology.
*   Effective communication skills and a strong willingness to learn and contribute in a collaborative team
environment.
**Halliburton is an Equal Opportunity Employer. Employment decisions are made without regard to race, color, religion, disability, genetic information, pregnancy, citizenship, marital status, sex/gender, sexual preference/ orientation, gender identity, age, veteran status, national origin, or any other status protected by law or regulation**.
**Location**
4th Floor, Gardenia 2D, Bengaluru, , 560103,
**Job Details**
**Requisition Number:** 201584
