---
id: hiringcafe-grnhse___hotmartcareersbr___4649539101
title: Senior Software Engineer - Frontend
company: Hotmart
location: 'Belo Horizonte, Minas Gerais, Brazil'
applicationLink: 'https://job-boards.eu.greenhouse.io/hotmartcareersbr/jobs/4649539101'
postedDate: '2025-08-15T21:14:42.000Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___hotmartcareersbr___4649539101'
companyLogoUrl: null
---
...
Atuar como guardião técnico do Checkout, garantindo aderência à arquitetura, domínio pleno das regras do produto, liderança na formação do time frontend e alavancagem de IA para ganho de eficiência.

  
**SUAS RESPONSABILIDADES / SEU DIA DIA:**

Atuar no desenvolvimento de soluções voltadas para diferentes níveis de complexidade, com foco contínuo na otimização de processos e tecnologias.
...
Revisar a qualidade das soluções propostas pelos seus pares fazendo Code review e aprovações de PRs.

Disseminar padrões e boas práticas frontend.

Criar experimentos e POCs que validem hipóteses de produto usando IA e automação

Alavancar IA na tribo: copilotos, automação de PRs, agentes de revisão e formação do time.

Atuar como ponto focal técnico front-end em salas de guerra, respondendo proativamente a alertas de produção e liderando a resolução de incidentes críticos que impactem o GMV do Checkout

Representar tecnicamente a tribo em discussões com arquitetura, produto e liderança.

**AS QUALIFICAÇÕES QUE VOCÊ PRECISA TER:**  
Dominar JavaScript, TypeScript, HTML, CSS  
Sólido conhecimento e experiência frameworks fron-end como React, Vue/Nuxt  
...
Capacidade de realizar monitoramento de erros e métricas (Sentry, Datadog, New Relic, etc.).  
Conhecimento de métodos de pagamento e regras de negócio  
Domínio de conceitos de AI aplicada à engenharia.  
Conhecimento em server-side rendering, BFF, bundlers e transpilers;  
Ter familiaridade com cultura DevOps e CI/CD (Pipelines automatizados de build e deploy (GitHub Actions, GitLab CI)
