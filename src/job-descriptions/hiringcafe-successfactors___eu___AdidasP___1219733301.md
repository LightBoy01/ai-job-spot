---
id: hiringcafe-successfactors___eu___AdidasP___1219733301
title: 'Senior Manager GBS Global Process I2C (Porto, 13, PT)'
company: Adidas Group
location: 'Porto, Porto, Portugal'
applicationLink: >-
  https://jobs.adidas-group.com/job/Porto-Senior-Manager-GBS-Global-Process-I2C-13/1219733301/
postedDate: '2025-09-29T09:31:45.807Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/successfactors___eu___AdidasP___1219733301'
companyLogoUrl: null
---
...
*   Develop new and adjust existing end to end processes/ services, standards or operational plans, and deliver results with direct impact on I2C stream, other streams and markets.
*   Significantly contribute to the I2C priorities, KPI’s and OKRs within the overall GBS roadmap
*   Manage transformation initiatives including GAP analysis related to the GBS operation centers/markets and provide process competency with a specific focus on I2C
*   Design, develop and implement process standardization, harmonization, automation, RPA, AI
*   Manage and execute new I2C systems/ technology/methodology roadmap and process change, upskill, train and execute
*   Contribute to selection of tools, techniques and systems according to architectural requirements and demands
*   Assess concepts and systems by finding scalable and future proven solution approaches in the standard solution, with workarounds or custom developments where needed.
*   Evaluate issues or new business requirements and translate into system enhancements.
*   Assist with defining new requirements associated with global integration projects
*   Manage testing support for new system enhancements and project implementation
*   Collaborate with delivery teams to ensure efficient and effective design, development, and implementation of new tools
...
*   Provide comprehensive expertise for I2C areas in line with latest taxonomy/ activity split, processes and technology towards operational and market finance teams
*   Coach, guide and develop assigned team members

**Key Relationships**

*   GBS O2C Senior Director
*   Global GPO O2I
...
*   Understanding of the relevant I2C sub-processes
...
*   Broad SAP knowledge (SD, FICO, etc)
...
*   Minimum of 5-8 years of relevant work experience of I2C
*   Ideally multiple years of experience in shared service center organizations
*   Strong understanding & knowledge of regional and global market landscape and the respective customers 
