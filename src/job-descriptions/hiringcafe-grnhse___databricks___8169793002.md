---
id: hiringcafe-grnhse___databricks___8169793002
...
postedDate: '2025-09-25T14:18:47.000Z'
expirationDate: null
tags:
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___databricks___8169793002'
companyLogoUrl: null
---
**FEQ326R328**
...
*   Location for the role is Munich or Berlin (or within a commutable distance for a hybrid schedule). 
*   Flexibility to travel (up to 20–30% as required for customer meetings, events, and training).
*   Business proficiency in English is required as a minimum. Fluency in German is a PLUS. Fluency in additional regional languages, such as Italian or French, may be advantageous.
...
*   Focus are Strategic customers, who are wanting to use Databricks, helping to gain traction and accelerate the platform usage by winning new use cases
...
*   Experience in AI/ML MVPs and/or SAP Business Data Cloud with leading consulting firms or hyperscalers
