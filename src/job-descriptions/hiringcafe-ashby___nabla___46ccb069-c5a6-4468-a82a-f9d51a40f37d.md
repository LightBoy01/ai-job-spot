---
id: hiringcafe-ashby___nabla___46ccb069-c5a6-4468-a82a-f9d51a40f37d
title: Tech Talent Acquisition Specialist
company: Nabla
location: Paris or United States
applicationLink: 'https://jobs.ashbyhq.com/nabla/46ccb069-c5a6-4468-a82a-f9d51a40f37d'
postedDate: '2025-09-26T17:18:30.260Z'
expirationDate: null
tags:
  - Human Resources
  - full-cycle
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/ashby___nabla___46ccb069-c5a6-4468-a82a-f9d51a40f37d'
companyLogoUrl: null
---
**About Nabla**
---------------
...
As a **Tech Recruitment Specialist**, you’ll drive recruiting efforts across our engineering and technical teams — from sourcing to candidate coordination. You’ll work closely with hiring managers to define needs, build pipelines, and ensure candidates have a smooth, transparent process that reflects Nabla’s culture.

We’re looking for a **Talent Acquisition Specialist** to join our Paris team and focus on scaling Nabla’s technical organization. You’ll recruit software engineers, Product Managers, data scientists, and machine learning experts, helping us build the teams that power our AI-driven healthcare solutions. This is an exciting opportunity to shape a fast-paced, mission-driven tech environment where your work directly impacts how clinicians experience Nabla’s product.

**Key Responsibilities**

*   **Full-Cycle Support**: Manage end-to-end recruiting for engineering and technical roles (e.g., software engineering, ML/AI, data, infra).
    
*   **Sourcing & Outreach**: Develop creative strategies to identify and engage top tech talent in competitive markets.
    
*   **Candidate Experience**: Ensure a smooth, professional, and engaging process for every candidate.
    
*   **Hiring Manager Collaboration**: Partner with engineering leaders to understand role requirements and deliver strong candidate pipelines.
    
*   **Process Management**: Maintain recruiting tools, scheduling, and documentation to keep the process efficient and scalable.
    
*   **Employer Brand**: Represent Nabla’s mission, culture, and technical challenges to prospective candidates.
    

**Your DNA:**

*   **5+ years of experience in tech recruitment**, with a focus on engineering, data, or ML hiring.
    
*   Proven sourcing expertise: you proactively build technical pipelines, not just rely on inbound.
    
*   **Data-driven mindset**, leveraging insights beyond standard recruiting metrics (e.g., sourcing contribution, funnel health, candidate quality, hiring manager satisfaction) to improve results and influence leadership.
    
*   Known for **strong ownership and autonomy**
    
*   An **expert negotiator**, with a track record of converting top candidates in competitive markets.
    
*   Skilled at influencing hiring managers and leadership, acting as a **trusted partner** in talent decisions.
    
*   Comfortable **leveraging AI and automation tools** to boost sourcing productivity, streamline operations, and improve candidate experience.
    
*   _(Nice to have)_ **Experience with Ashby** or similar modern ATS platforms, using them to build structured, data-driven recruiting workflows..
...
There is an active employment scam which is now using Nabla to collect personal information or financial scams. If you’re contacted by a Nabla recruiter, please ensure whomever is contacting you truly represents Nabla and is utilizing a [nabla.com](http://nabla.com) email address. We will never ask for the exchange of any money or credit card details during the recruitment process. Nabla utilizes a hiring platform for all applications; please be aware of any suspicious email activity from people who could be pretending to be recruiters or senior professionals at Nabla. You can find more information following this [link](https://consumer.ftc.gov/consumer-alerts/2023/05/scammers-are-hijacking-job-ads-heres-how-spot-fakes).  
_Nabla does not accept unsolicited CVs from recruiters or employment agencies in response to the Nabla Careers page or a Nabla social media post. Any unsolicited CVs, including those submitted directly to hiring managers, are deemed to be the property of Nabla._
