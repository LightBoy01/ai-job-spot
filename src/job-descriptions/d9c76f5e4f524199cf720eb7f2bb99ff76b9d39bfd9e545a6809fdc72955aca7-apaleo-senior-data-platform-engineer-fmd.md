---
id: d9c76f5e4f524199cf720eb7f2bb99ff76b9d39bfd9e545a6809fdc72955aca7
title: Senior Data Platform Engineer (f/m/d)
company: Apaleo
location: 'München, Bavaria, Germany'
applicationLink: >-
  https://www.arbeitnow.com/jobs/companies/apaleo/senior-data-platform-engineer-munchen-458670
postedDate: '2025-12-10T14:45:25.000Z'
expirationDate: null
tags: []
...
We're looking for a **Senior Data Platform Engineer** who will architect and scale the next generation of **AI-ready data warehouse solutions** for our customers. This is a hands-on, role for someone who blends deep technical expertise with forward-thinking product vision.

**What You'll Be Up To**

*   Collaborate on the **architecture design** of Apaleo's next-gen **AI-driven data warehouse platform**, enabling real-time analytics, automation, and intelligent recommendations.
...
*   Design and implement **high-performance data pipelines**, ensuring data accuracy, freshness, and accessibility across the organization.
...
*   **Several** years building and scaling **data warehouse or multi-tenant data platforms**, ideally within high-growth tech environments (e.g., e-commerce, travel, or delivery tech).
*   Solid understanding of cloud platforms architecture principles (AWS, GCP, or Azure)
*   Proven experience with at least one cloud-native data warehouse solution, such as **Snowflake, Redshift, or BigQuery**.
*   Expertise in **Python, SQL**, **ETL,** and pipeline orchestration (e.g. **Airflow**).
*   Deep knowledge in data modeling, performance optimization, data access management, data quality etc..
*   Ability to bridge technical and business perspectives through clear communication, fostering collaboration and delivering data-centric solutions to complex challenges.
*   Passion for **emerging GenAI technologies** (e.g., LLM integrations).
*   Nice to have:
    *   Understanding of API-first ecosystems
    *   Knowledge of .NET ORM (Object-Relational Mapper)
