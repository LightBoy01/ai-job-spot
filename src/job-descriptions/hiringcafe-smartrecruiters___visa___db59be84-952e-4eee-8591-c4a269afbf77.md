---
id: hiringcafe-smartrecruiters___visa___db59be84-952e-4eee-8591-c4a269afbf77
title: 'Sr. Software Engineer (Java, Gen AI, Fullstack)'
company: Visa
location: 'Bellevue, Washington, United States'
applicationLink: >-
  https://jobs.smartrecruiters.com/Visa/744000084271596-sr-software-engineer-java-gen-ai-fullstack-
postedDate: '2025-09-26T17:38:16.266Z'
expirationDate: null
tags:
...
source: hiring.cafe
sourceUrl: >-
  https://hiring.cafe/jobs/smartrecruiters___visa___db59be84-952e-4eee-8591-c4a269afbf77
companyLogoUrl: null
---
**Company Description:**
...
We are seeking a talented and motivated Sr. Software Engineer to join our VAS Innovation team. As a key member of the team, you will play a critical role in developing cutting-edge solutions, leveraging innovative technologies, and enhancing the capabilities of our Value-Added Services (VAS) platform.

You will be tasked to quickly grasp and evaluate new ideas and technologies from both internal and external sources and match them appropriately with emerging technology and business opportunities, building a culture of innovation and a drive for excellence.

**Essential Functions:**

*   **Innovative Development:** Engage in the design, development, and implementation of innovative software solutions, using generative AI and modern integration patterns. Contribute to a culture of innovation by actively exploring and applying new ideas and technologies.
...
*   **Language Expertise**: Expertise in one or more general development languages (e.g., Java, Python, NodeJS, C#, C++)
*   **Builder**: Experience building and deploying modern services and web applications with quality and scalability
*   **Learner**: Constant drive to learn new technologies such as GenAI, Angular, React, Kubernetes, Docker, etc.
...
NOTE: This role does not offer relocation assistance or immigration support now or in the future.
...
*   Experience with **model compression**, **MLOps**, **robustness**
    
*   **System Design & DevOps**
    
*   CI/CD: **Jenkins**, **Git**, **Maven**, **Docker**, **Kubernetes**
    
*   Infra as Code: **Terraform**
    
*   Experience with **Redis**, **Kafka**, **Cassandra**
    
*   Integrated **AI into production systems**
    
*   **Web & Front-End**
    
*   Experience with **ReactJS**, **Angular**, **NodeJS**
    
*   **Security & Auth**
    
*   Knowledge of **OAuth2.0**, **SSO**, **certificate management**
    
*   Familiar with **cryptography**, **SSDLC**, **app security**
    
*   **Other**
    
*   Experience with large datasets and cloud infrastructure
