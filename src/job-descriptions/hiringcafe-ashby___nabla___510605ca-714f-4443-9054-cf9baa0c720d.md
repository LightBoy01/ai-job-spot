---
id: hiringcafe-ashby___nabla___510605ca-714f-4443-9054-cf9baa0c720d
title: Product Manager
company: Nabla
location: 'Paris, Île-de-France, France'
applicationLink: 'https://jobs.ashbyhq.com/nabla/510605ca-714f-4443-9054-cf9baa0c720d'
postedDate: '2025-04-28T11:53:40.810Z'
expirationDate: null
tags:
  - Product Management
  - Lead discovery
...
salaryRange: null
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/ashby___nabla___510605ca-714f-4443-9054-cf9baa0c720d'
companyLogoUrl: null
---
**About Nabla**
---------------
...
The product team is a tight-knit group of builders, designers, and strategists. Together with engineering, we define and deliver high-impact tools that delight clinicians and solve their most pressing pain points.

**Responsibilities**
====================

*   **Product discovery**: Lead product discovery efforts by identifying and validating opportunities through usability studies, user research, and data analysis. Ensure decisions are data-driven and customer-centric.
    
*   **Roadmap prioritization**: Identify elegant and simple product features, prioritize them based on business impact, and organize them into product roadmaps.
    
*   **Product execution**: Own the product execution process, working closely with designers, engineers, and the broader team. Ensure high-quality product delivery with a focus on attention to detail and user delight.
    
*   **Strategic decision**: Collaborate with the product and executive teams to contribute to strategic decisions that drive the company forward, ensuring that products align with overall business and user goals.
    

**Your DNA:**
=============

*   3+ years of product management experience in a technical or engineering-heavy environment
    
*   Experience managing product lifecycles, ideally with exposure to both building new products (0→1) and scaling existing ones (1→n)
    
*   Familiarity with AI/ML systems, data infrastructure, or developer platforms (hands-on experience a strong plus)
    
*   Strong systems thinking — able to understand complex architectures, anticipate dependencies, and make sound tradeoffs
    
*   Some exposure to regulated or safety-critical industries (healthcare experience a plus)
    
*   Clear and structured communicator — comfortable explaining tradeoffs and decisions to both technical and non-technical audiences
    
*   Proven track record of collaborating with engineering, design, and other teams to ship impactful technical products
...
Remote policy: 1 day a week (with some flexibility). Possibility of working remotely 1-2 weeks once a year.
