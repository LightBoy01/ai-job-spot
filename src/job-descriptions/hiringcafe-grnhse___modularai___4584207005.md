---
id: hiringcafe-grnhse___modularai___4584207005
title: Lead AI Graph Compiler Engineer
company: Modular
location: United States or Canada
applicationLink: 'https://www.modular.com/company/career-post?4584207005&gh_jid=4584207005'
postedDate: '2025-09-29T09:31:49.855Z'
expirationDate: null
tags:
...
source: hiring.cafe
sourceUrl: 'https://hiring.cafe/jobs/grnhse___modularai___4584207005'
companyLogoUrl: null
---
### About Modular
...
Modular is looking for a Lead AI Graph Compiler Engineer to work on multi-framework, multi-hardware and user-extensible compiler infrastructure. The Modular Graph Compiler is a central piece of our stack that bridges the gap between frameworks and hardware for ML models. We’re looking for ambitious engineers who are willing to develop their skills and learn from an incredible team. You will contribute to the design, implementation, and integration of graph compiler features with the rest of the modular stack, and will learn communication and teamwork skills to collaborate across team boundaries.
...
*   Build an MLIR and LLVM-based machine learning compiler with scalable and high quality infrastructure
*   Write generic and extensible optimizations, such as constant folding, operation fusion, model parallelization, and quantization.
*   Analyze and improve performance across multiple different model architectures.
*   Work with other teams to provide a balanced stack that fully utilizes today’s complex hardware.
...
The estimated base salary range for this role to be performed in the US, regardless of the state, is **$234,000.00 - $273,000.00 U****SD**. The estimated base salary range for this role to be performed in Canada, regardless of the province, is **$221,000.00 - $258,000.00 CAD**.  
