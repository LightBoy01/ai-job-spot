---
id: >-
  hiringcafe-workday___workday-wd5-workday___principal-software-development-engineer--flowise_jr-0100573
title: 'Principal Software Development Engineer, Flowise'
company: Workday
location: 'Pleasanton, California, United States'
applicationLink: >-
  https://workday.wd5.myworkdayjobs.com/workday/job/USA-CA-Pleasanton/Principal-Software-Development-Engineer--Flowise_JR-0100573
...
source: hiring.cafe
sourceUrl: >-
  https://hiring.cafe/jobs/workday___workday-wd5-workday___principal-software-development-engineer--flowise_jr-0100573
companyLogoUrl: null
---
...
At Flowise, our team is dedicated to simplifying the creation of AI solutions. Our low-code platform makes it easy to build powerful chatbots and autonomous agents. By abstracting complex frameworks into intuitive visual components, we enable users to create sophisticated AI workflows without extensive coding knowledge.  
  
With Workday's recent acquisition, we will provide customers with an easy-to-use platform to quickly and responsibly build and deploy AI agents for HR and finance. This partnership also empowers partners to build faster, expand their offerings, and deliver quicker value to shared customers.  
  
Come be part of the team! We are hiring in several areas, including product, engineering, and design to help drive this exciting initiative.
...
*   6+ years of hands-on experience with our core stack: JavaScript/TypeScript, Node, React, Express, Turbo (Flowise is a monorepo)
...
*   ****Systems & Architecture**:** Demonstrated proficiency in building and consuming external APIs, integrating with third-party services, and designing large-scale distributed systems. Experience with message queuing technologies like RabbitMQ, BullMQ, Kafka, or SQS is highly desirable.
...
Primary Location Base Pay Range: $201,600 USD - $302,400 USD

  
 

Additional US Location(s) Base Pay Range: $170,200 USD - $302,400 USD
