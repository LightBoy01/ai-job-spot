---
id: 8a60967fc6cc25e1ec97149a577ab44dea73c95a91ad9cbca4a7637c073412b9
title: Full-Stack Developer (Working Student)
company: acemate.ai
location: Berlin
applicationLink: >-
  https://www.arbeitnow.com/jobs/companies/acemateai/full-stack-developer-working-student-berlin-255723
postedDate: '2025-11-27T09:31:54.000Z'
expirationDate: null
tags:
...
companyLogoUrl: null
companyCulture: >-
  acemate fosters a young, driven team culture focused on innovation in
  education, high autonomy, and a "builder" mindset. They minimize meetings to
  maximize coding and creative work, while also promoting continuous learning
  and offering a flexible environment with team events.
story_question1: >-
  How does a working student contribute significantly to product and
  architectural decisions at acemate, and what's the learning curve like for
  someone new to the specific tech stack?
story_answer1: >-
  Honestly, it's not your typical 'working student' gig where you're just
  fetching coffee or doing grunt work. Here at acemate, everyone's a core team
  member. Even as a working student, you'll be diving headfirst into real
  challenges – building out new features, optimizing AI pipelines, and even
  influencing our architectural choices. The expectation is that you think like
  a founder; we give you the autonomy and trust to make a real impact. And don't
  worry about knowing every piece of our tech stack from day one – we prioritize
  a commitment to learning and adaptability. We believe in your ability to pick
  things up quickly, and the team is always there for ad-hoc discussions and
  mentorship. It's a fast-paced environment where you'll learn an incredible
  amount by doing.
story_question2: >-
  Given acemate's rapid growth and mission to democratize personalized learning,
  what is the biggest challenge the development team faces in scaling the
  platform while maintaining a high-quality, personalized user experience for
  diverse institutional settings?
story_answer2: >-
  The biggest balancing act for us right now is definitely scaling our platform
  to support a rapidly growing number of institutions across different regions,
  each with their own unique content and authorization needs, all while ensuring
  we deliver truly personalized and engaging learning experiences. It's not just
  about building features; it's about architecting a robust and flexible system
  that can handle complex AI pipelines, ingest diverse content, and then present
  it in a Duolingo-inspired, engaging way. We're constantly iterating on our AI
  toolchains and custom authorization engine to meet these demands. The
  challenge is immense, but it's incredibly rewarding to see our work directly
